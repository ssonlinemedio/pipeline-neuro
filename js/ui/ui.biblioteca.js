...
class UIBiblioteca {
    ...
    _ttsEscucharHistoria() {
        ...
        const playbackToken = ++this._historiaPlaybackToken;
    ...
    _ttsDetener() { this._dualTTSToken++; this._historiaPlaybackToken++; window.TTS?.stop(); }
